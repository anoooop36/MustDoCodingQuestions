...
class Solution
{
    void booleanMatrix(int matrix[][])
    {
		...
		/*
			a space optimized solution is to use first row and first coulumn of matrix to store info of row and col.
			but first row and first col needs to be filled separately after filling matrix
		*/
    }
}