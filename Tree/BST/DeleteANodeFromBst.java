...
class Tree {
    ...
    /*
     * idea is to remove node and attach its child with its parent (in case of
     * single or no child) if node has two childs get min of left subtree (inorder
     * succesor must be leaf or node with right subtree). change value of root by
     * successors value and delete successor on right subtree.
     */
