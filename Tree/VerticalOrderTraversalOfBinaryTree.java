...
class BinaryTree {
    /*
     * Use level order traversal. Keep horizontal distances in along with node in
     * queue. Need to maintain a list of numbers for each horizontal distance of
     * tree in map. minHd and maxHd will help to print from leftmost to right most
     */
